...
export const searchItems = [
  ...
  {
    id: 'video-mrpl-01',
    title: 'MRPL Refinery Safety & Hazards Induction',
    description: 'Safety induction training covering emergency assembly locations, personal protective equipment (PPE), and hazards.',
    content: 'All refinery operations require mandatory PPE. Ensure steel-toe shoes, safety helmets, and fire-resistant jackets are worn at all times. Emergency exit points are marked in green.',
    type: 'video',
    category: 'Safety',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
    clicks: 40
  ...
  {
    id: 'video-mrpl-02',
    title: 'Refinery Distillation & Towers Operation',
    description: 'Training detailing towers pressure flow, catalytic separators, and petroleum distillation columns.',
    content: 'Fractional distillation separates crude oil into gas, naphtha, kerosene, diesel, and residue fractions inside distillation towers under strict pressure monitoring.',
    type: 'video',
    category: 'Operations',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4',
    clicks: 25
  ...
  {
    id: 'video-mrpl-03',
    title: 'Environmental and Pollution Control Guidelines',
    description: 'Overview of refinery waste recycling systems, environmental emissions monitoring, and air filtering.',
    content: 'Environmental safety mandates using sulfur recovery units (SRU) and daily monitoring of wastewater discharge parameters to satisfy environmental regulations.',
    type: 'video',
    category: 'Compliance',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4',
    clicks: 18
